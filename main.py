...
def products():
    ...
    itemData = parse(itemData)   
    return render_template('products.html', itemData=itemData, loggedIn=loggedIn, firstName=firstName, noOfItems=noOfItems)
...
def checkout():
    loggedIn, firstName, noOfItems = getLoginDetails()
    return render_template("thanks.html", loggedIn=loggedIn, firstName=firstName, noOfItems=noOfItems)
